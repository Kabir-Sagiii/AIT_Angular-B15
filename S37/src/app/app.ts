...
@Component({
  selector: 'app-root',
  imports: [Signup, Cart, ContactUs, Signin, Users, ProductDetails, Comp1, Comp2, Details, Parent, RouterOutlet, AttributeDir, Switchdir, Products, StructuralD, FormsModule, Twoway, Home, Profilecard, Divcontainer, Bindingtask, Product, Nav],
