...
@Component({
  selector: 'app-root',
  imports: [Users,ProductDetails,Comp1,Comp2,Details,Parent,RouterOutlet,AttributeDir,Switchdir,Products,StructuralD,FormsModule,Twoway,Home,Profilecard,Divcontainer,Bindingtask],
